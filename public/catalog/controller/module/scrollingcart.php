...
class ControllerModuleScrollingcart extends Controller {
	...
	public function index() {
		...
		$data['text_items_count'] = sprintf($this->language->get('text_items_count'), $this->cart->countProducts());
		$data['button_remove'] = $this->language->get('button_remove');
		$data['text_total'] = sprintf($this->language->get('text_items_count'), $this->currency->format($total));
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/scrollingcart.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/scrollingcart.tpl', $data);
		} else {
			return $this->load->view('default/template/module/scrollingcart.tpl', $data);
		}
	}
